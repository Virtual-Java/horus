...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/pi/3D-scanner/bqlabs/horus/horus_manual_build/virenv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/pi/3D-scanner/bqlabs/horus/horus_manual_build/virenv/bin/deactivate.nu'
